...
QT_MOC_LITERAL(1, 5, 16), // "back_signal_user"
QT_MOC_LITERAL(2, 22, 0), // ""
QT_MOC_LITERAL(3, 23, 9) // "back_send"

    },
    "user\0back_signal_user\0\0back_send"
};
...
void user::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->back_signal_user(); break;
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&user::back_signal_user)) {
                *result = 0;
                return;
            }
        }
